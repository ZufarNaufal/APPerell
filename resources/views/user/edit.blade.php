  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Profile</li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4><i class="fa fa-user"></i>myprofile</h4>
                        <table class="table">
                            <thead>
                                <tr>
                                    <td>Nama</td>
                ...
                <form method="POST" action="{{ url('profile') }}">
                      ...
                      <!--  <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nohp" type="text" class="form-control @error('nohp') is-invalid @enderror" name="nohp" value="{{ $users->nohp }}" required autocomplete="nohp" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" class="form-control @error('nohp') is-invalid @enderror">{{ $users->alamat }}</textarea>
