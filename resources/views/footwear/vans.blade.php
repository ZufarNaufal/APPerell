...
<div class="container mt-5">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="#">
      <img src="../uploads/oldskull.jpg" class="d-block w-100" alt="...">
      </a>
      <div class="carousel-caption d-none d-md-block">
        <h5 style="color:Black;"><b>Vans Old Skull Black/White Global Size</b></h5>
        <p style="color:Black;">IDR 600,000</p>
      </div>
    </div>
    <div class="carousel-item">
      <a href="#">
      <img src="../uploads/slipon.jpg" class="d-block w-100" alt="...">
      </a>
      <div class="carousel-caption d-none d-md-block">
        <h5 style="color:Black;"><b>Slip On Checkerboard Global Size</b></h5>
        <p style="color:Black;">IDR 600,000</p>
      </div>
    </div>
  </div>
