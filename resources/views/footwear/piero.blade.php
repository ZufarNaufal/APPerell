...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      Vans X Toy Story is Available on store in 21 august 
      </div>
...
<div class="container mt-5">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="#">
      <img src="../uploads/aw.jpg" class="d-block w-100" alt="...">
      </a>
      <div class="carousel-caption d-none d-md-block">
        <h5 style="color:Black;"><b>Piero Arc Wave</b></h5>
        <p style="color:Black;">IDR 300,000</p>
      </div>
    </div>
    <div class="carousel-item">
      <a href="#">
      <img src="../uploads/joggerdnm.jpg" class="d-block w-100" alt="...">
      </a>
      <div class="carousel-caption d-none d-md-block">
        <h5 style="color:Black;"><b>Piero Jogger Denim</b></h5>
        <p style="color:Black;">IDR 300,000</p>
      </div>
    </div>
  </div>
